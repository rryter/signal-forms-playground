  ...
  template: `
    <div class="app-container">
      ...
      <footer>
        <p>
          Based on
          <a href="https://timdeschryver.dev/blog/refactoring-a-form-to-a-signal-form" target="_blank">
            Tim Deschryver's Blog Post
          </a>
        </p>
      </footer>
    </div>
...
const routes: Routes = [
  ...
  },
  {
    path: 'basic',
    loadComponent: () =>
      import('./signal-forms/signal-forms-basic/signal-forms-basic.component').then(
        m => m.SignalFormsBasicComponent
      )
  },
];
